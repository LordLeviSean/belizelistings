...
import { formatDistrictHeaderCount } from "../lib/districtInventorySummary";
...
export default function DistrictLayout({
  ...
  const headerCount = formatDistrictHeaderCount({
  ...
  return (
    <>
      <section className={styles.districtHeader} aria-label="District browse">
        <div className={styles.districtHeaderRow}>
          <div className={styles.districtHeaderTitle}>
            ...
            <p className={styles.districtHeaderCount} aria-live="polite">
              {headerCount}
            </p>
          </div>

          <div className={styles.districtHeaderControls}>
            <form className={styles.districtSearch} onSubmit={onSearchSubmit} role="search">
              <label className={styles.districtSearchWrap} htmlFor="district-search-query">
                <span className={styles.districtSearchIcon} aria-hidden="true">
                  <Search size={16} strokeWidth={2} />
                </span>
                <input
                  id="district-search-query"
                  ref={searchInputRef}
                  type="search"
            ...
            {!filtersExpanded ? (
              <button
                type="button"
                className={`${styles.showFiltersBtn} ${hasActiveFilters ? styles.showFiltersBtnActive : ""}`}
                aria-expanded={filtersExpanded}
                aria-label={hasActiveFilters ? "Show filters, filters active" : "Show filters"}
      ...
      {filtersExpanded ? (
        <section className={styles.filterBarShell}>
          ...
          <div className={styles.filterPanel} role="region" aria-label="District listing filters">
            <button
              type="button"
            ...
            <div className={styles.filterInventoryMeta}>
              <p className={styles.filterPanelCount} aria-live="polite">
                {headerCount}
              </p>
              <button
                type="button"
